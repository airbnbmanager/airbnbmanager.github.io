...
function roomFormFields(r = {}, emps = []) {
  return `
    ...
    <div class="form-group"><label>📶 WiFi Name (SSID)</label><input id="wifiSsid" value="${r.wifi_ssid || ''}" placeholder="e.g. UniqueHaven_WiFi" /></div>
    <div class="form-group"><label>🔑 WiFi Password</label><input id="wifiPassword" value="${r.wifi_password || 'Airbnb.in1'}" placeholder="Airbnb.in1" /></div>
...
function collectRoomForm() {
  ...
  return {
    ...
    wifi_password: document.getElementById('wifiPassword')?.value.trim() || 'Airbnb.in1',
